...
item=json.loads((root/'content/automation/2026-08-28-1400.json').read_text())
...
pub=root/'scripts/publish_blogger.py'; s=pub.read_text(); key='como montar um orçamento mensal simples sem planilha complicada'
if key not in s:
    marker='COVER_BY_TITLE = {'
    s=s.replace(marker, marker+'\n    "'+key+'": f"{COVER_BASE}/orcamento-simples-sem-planilha-20260828.svg",')
    pub.write_text(s)
